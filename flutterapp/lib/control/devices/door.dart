...
import 'package:flutterapp/common/tool/mjpegViewer.dart';
...
class _DoorState extends State<DoorWidget> {
  ...
  void initState() {
    ...
    mqttConnect("topic/door/camera/control", "on", null);
  }
                    ...
                    children: <Widget>[
                        new Card(
                            ...
                            child: Container(
                                    ...
                                    child: MjpegView(url: 'http://192.168.8.133:8088/?action=stream', fps: 2),
                                ),
                        ),
                        Row(
                            mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget lockButtonWidget (){
      return IconButton(
                ...
                onPressed: () {
                    ...
                    mqttConnect("topic/door/lock/control", isLocked ? "lock" : "unlock", null);
...
final MqttClient client = MqttClient('192.168.8.1', '');
  ...
  Future<int> mqttConnect(topic, message, myCallback) async{
